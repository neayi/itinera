...
**⚠️ VÉRIFICATION CRITIQUE** : Le champ "value" DOIT correspondre EXACTEMENT au résultat final de la dernière ligne de "calculation_steps". Si ton calcul donne 75 qtx/ha, alors "value" doit être 75, PAS une autre valeur. Vérifie toujours cette cohérence avant de retourner le JSON.
